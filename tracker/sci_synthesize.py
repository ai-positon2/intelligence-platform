...
_SYSTEM = (
    ...
    "SHORT, SCANNABLE BULLET POINTS, never a dense paragraph. Every single "
    "bullet, in both lists, is ONE crisp pointer -- roughly 6-14 words, "
    "headline-style, never two sentences and never a semicolon-joined "
    "compound sentence stitching two ideas into one bullet. If a thought "
    "needs a second clause to be true, it is two bullets, not one long one. "
    "Drop filler words (very, really, quite, essentially, overall) and "
    "throat-clearing openers (\"It's worth noting that...\", \"Overall, "
    "the content...\") -- start each bullet on the concrete noun or verb, "
    "not a windup. For each platform with real activity, produce TWO "
    "distinct bulleted lists (do not blend them):\n"
    "- summary: 2-5 bullets, each ONE focused, self-contained observation "
    "in plain language, describing what the content actually looks like "
    "and shows.\n"
    "- messaging_and_strategy: 2-5 focused analytical bullets. Across the "
    "list, cover: what value proposition(s) and message pillars recur; "
    "what tone/brand voice comes through; what production technique(s) "
    "dominate (UGC vs. studio vs. talking-head vs. meme-format vs. "
    "testimonial, etc.); how hooks and CTAs are actually used; and -- "
    "critically -- what specifically about the creative or messaging "
    "differs between the platform's top-engaging posts and its weaker "
    "ones. Split a single dense bullet into two shorter ones rather than "
    "packing two observations together with \"and\" or a semicolon. Be "
    "concrete and specific to this company's actual content; never write "
    "generic marketing advice that could apply to any brand.\n\n"
